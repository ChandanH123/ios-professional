...
//  Bankey
//
//  Created by Chandan on 18/01/23.
//
...
extension ShakeyBellView {
    ...
    func style() {
        ...
        buttonView.layer.cornerRadius = buttonHeight/2 // this makes the perfect circle using CALayer.
...
extension ShakeyBellView {
    ...
    private func shakeWith(duration: Double, angle: CGFloat, yOffset: CGFloat)
    {
        ...
        imageView.setAnchorPoint(CGPoint(x: 0.5, y: yOffset)) // this func enables us to set our anchor/rotation point at the top of the bell without actually moving the imageView itself.
...
//MARK: - change anchor point
extension UIView {
    // below func enables us to set our anchor/rotation point at the top of the bell without actually moving the imageView itself.
